...
PIDController* RobotMap::winchBalancePID = NULL;
...
void RobotMap::init() {
	...
	winchEncoder = new Encoder(WINCH_ENCODER_PORT_1, WINCH_ENCODER_PORT_2, true, Encoder::k2X);
	...
	winchBalancePID = new PIDController(WINCH_BALANCE_P, WINCH_BALANCE_I, WINCH_BALANCE_D, winchEncoder, winchtalon);
